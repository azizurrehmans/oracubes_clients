CREATE OR REPLACE FORCE VIEW addos.hr_emp_fin_latest_view2 (employee_id,
                                                            earning,
                                                            gross,
                                                            deduction,
                                                            net_salary
...
-- ,e.REMARKS
          ...
          ef2.gross grosssalary,
          ef2.net_salary net_salary,
          ef2.deduction deduction,
           e.dob
          , e.city_id, e.country_id
          , e.email, 
         ef2.earning gross_salary,
